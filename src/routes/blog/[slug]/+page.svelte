  ...
  let breadcrumbSchema = $derived({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: $t.blog.title,
        item: `https://www.loflog.com${$currentLang === "zh" ? "/zh" : ""}/blog`,
      },
      {
        "@type": "ListItem",
        position: 3,
        name: activePost?.title || "",
        item: `https://www.loflog.com${$currentLang === "zh" ? "/zh" : ""}/blog/${data.post.slug}`,
      },
    ],
  });
  ...
  articleSchema={activePost
    ? {
        ...
        image: activePost.image
          ? [`https://www.loflog.com${activePost.image}`]
          : [],
        datePublished: activePost.date,
        author: [
          {
            "@type": "Person",
            name: activePost.author || "Loflog Team",
